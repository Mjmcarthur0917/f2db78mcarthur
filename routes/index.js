...
router.get('/', function (req, res) {
  res.render('index', { title: 'Hunting App', user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Hunting App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Hunting App Login', user : req.user });
});
